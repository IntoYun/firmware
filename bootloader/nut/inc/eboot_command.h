...
enum action_t {
    ACTION_COPY_APP    = 0x00000001,
    ACTION_COPY_DEFAPP = 0x00000002,
...
struct eboot_command{
    ...
    uint32_t online_app_addr[2];   //[0]:src  [1]:dst
    uint32_t online_app_size;
    uint32_t default_app_addr[2];
    uint32_t default_app_size;
    uint32_t boot_size;
    uint32_t crc32;
};
