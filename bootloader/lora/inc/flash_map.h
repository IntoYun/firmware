...
#define BOOT_PARAMS_START_ADDR           ((uint32_t)0x10000)
#define BOOT_PARAMS_END_ADDR             ((uint32_t)0x10FFF)
#define SYSTEM_PARAMS_START_ADDR         ((uint32_t)0x11000)
#define SYSTEM_PARAMS_END_ADDR           ((uint32_t)0x17FFF)
