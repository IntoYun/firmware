...
# FLAGS For nut
CFLAGS += -I nut/inc/inc_board/
CFLAGS += -I nut/inc/inc_mcu/
CFLAGS += -I nut/inc/inc_services/
CFLAGS += -I nut/inc/inc_system/
CFLAGS += -I nut/inc/inc_wiring/
...
LDFLAGS += -L nut/lib
LIBS += hal platform services system wiring
