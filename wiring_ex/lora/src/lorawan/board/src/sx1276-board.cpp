...
void SX1276IoIrqInit( DioIrqHandler **irqHandlers )
{
    ...
    */
    attachInterrupt(DIO0, irqHandlers[0], RISING, 4, 0);
    attachInterrupt(DIO1, irqHandlers[1], RISING, 4, 0);
    attachInterrupt(DIO2, irqHandlers[2], RISING, 4, 0);
    attachInterrupt(DIO3, irqHandlers[3], RISING, 4, 0);
    attachInterrupt(DIO4, irqHandlers[4], RISING, 4, 0);
    attachInterrupt(DIO5, irqHandlers[5], RISING, 4, 0);
}
