...
void setup()
{
    ...
    IntoRobot.defineDataPointNumber(DPID_NUMBER_TEMPERATURE, UP_ONLY, 0, 100, 0.1, 0);   //温度
    ...
    IntoRobot.defineDataPointNumber(DPID_NUMBER_RHEOSTAT, UP_DOWN, 0, 100, 1, 0);        //速度
...
{
    delay(10000);
    IntoRobot.sendDataPoint(DPID_ENUM_LIGHT_MODE, 1);
    IntoRobot.sendDataPoint(DPID_NUMBER_TEMPERATURE, 11.11);
    IntoRobot.sendDataPoint(DPID_BOOL_SWITCH, true);
    IntoRobot.sendDataPoint(DPID_BOOL_LIGHT_STATUS, true);
    IntoRobot.sendDataPoint(DPID_NUMBER_RHEOSTAT, 343);
    IntoRobot.sendDataPoint(DPID_STRING_LCD_DISPLAY, "adfb");
