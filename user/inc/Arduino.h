...
#if !defined(SERIAL_PORT_MONITOR) && (FIRMWARE_CONFIG_WIRING_USART > 0)
#define SERIAL_PORT_MONITOR               Serial
#endif

#if !defined(SERIAL_PORT_USBVIRTUAL) && (FIRMWARE_CONFIG_WIRING_USB_USART > 0)
#define SERIAL_PORT_USBVIRTUAL            SerialUSB
#endif

#if !defined(SERIAL_PORT_HARDWARE_OPEN) && (FIRMWARE_CONFIG_WIRING_USART > 0)
#define SERIAL_PORT_HARDWARE_OPEN         Serial
#endif

#if !defined(SERIAL_PORT_HARDWARE_OPEN1) && (FIRMWARE_CONFIG_WIRING_USART > 1)
#define SERIAL_PORT_HARDWARE_OPEN1        Serial1
#endif

#if !defined(SERIAL_PORT_HARDWARE_OPEN2) && (FIRMWARE_CONFIG_WIRING_USART > 2)
#define SERIAL_PORT_HARDWARE_OPEN2        Serial2
#endif

#if !defined(SERIAL_PORT_HARDWARE_OPEN3) && (FIRMWARE_CONFIG_WIRING_USART > 3)
#define SERIAL_PORT_HARDWARE_OPEN3        Serial3
#endif

#if !defined(SERIAL_PORT_HARDWARE_OPEN4) && (FIRMWARE_CONFIG_WIRING_USART > 4)
#define SERIAL_PORT_HARDWARE_OPEN4        Serial4
#endif

#if !defined(SERIAL_PORT_HARDWARE_OPEN5) && (FIRMWARE_CONFIG_WIRING_USART > 5)
#define SERIAL_PORT_HARDWARE_OPEN5        Serial5
#endif

#if !defined(SERIAL_PORT_HARDWARE) && (FIRMWARE_CONFIG_WIRING_USART > 0)
#define SERIAL_PORT_HARDWARE              Serial
#endif

#if !defined(SERIAL_PORT_HARDWARE1) && (FIRMWARE_CONFIG_WIRING_USART > 1)
#define SERIAL_PORT_HARDWARE1             Serial1
#endif

#if !defined(SERIAL_PORT_HARDWARE2) && (FIRMWARE_CONFIG_WIRING_USART > 2)
#define SERIAL_PORT_HARDWARE2             Serial2
#endif

#if !defined(SERIAL_PORT_HARDWARE3) && (FIRMWARE_CONFIG_WIRING_USART > 3)
#define SERIAL_PORT_HARDWARE3             Serial3
#endif

#if !defined(SERIAL_PORT_HARDWARE4) && (FIRMWARE_CONFIG_WIRING_USART > 4)
#define SERIAL_PORT_HARDWARE4             Serial4
#endif

#if !defined(SERIAL_PORT_HARDWARE5) && (FIRMWARE_CONFIG_WIRING_USART > 5)
