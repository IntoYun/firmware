...
#if !defined(SERIAL_PORT_MONITOR) && defined(configWIRING_USARTSERIAL_ENABLE)
#define SERIAL_PORT_MONITOR               Serial
#endif

#if !defined(SERIAL_PORT_USBVIRTUAL) && defined(configWIRING_USBSERIAL_ENABLE)
#define SERIAL_PORT_USBVIRTUAL            SerialUSB
#endif

#if !defined(SERIAL_PORT_HARDWARE_OPEN) && defined(configWIRING_USARTSERIAL_ENABLE)
#define SERIAL_PORT_HARDWARE_OPEN         Serial
#endif

#if !defined(SERIAL_PORT_HARDWARE_OPEN1) && defined(configWIRING_USARTSERIAL1_ENABLE)
#define SERIAL_PORT_HARDWARE_OPEN1        Serial1
#endif

#if !defined(SERIAL_PORT_HARDWARE_OPEN2) && defined(configWIRING_USARTSERIAL2_ENABLE)
#define SERIAL_PORT_HARDWARE_OPEN2        Serial2
#endif

#if !defined(SERIAL_PORT_HARDWARE_OPEN3) && defined(configWIRING_USARTSERIAL3_ENABLE)
#define SERIAL_PORT_HARDWARE_OPEN3        Serial3
#endif

#if !defined(SERIAL_PORT_HARDWARE_OPEN4) && defined(configWIRING_USARTSERIAL4_ENABLE)
#define SERIAL_PORT_HARDWARE_OPEN4        Serial4
#endif

#if !defined(SERIAL_PORT_HARDWARE_OPEN5) && defined(configWIRING_USARTSERIAL5_ENABLE)
#define SERIAL_PORT_HARDWARE_OPEN5        Serial5
#endif

#if !defined(SERIAL_PORT_HARDWARE) && defined(configWIRING_USARTSERIAL_ENABLE)
#define SERIAL_PORT_HARDWARE              Serial
#endif

#if !defined(SERIAL_PORT_HARDWARE1) && defined(configWIRING_USARTSERIAL1_ENABLE)
#define SERIAL_PORT_HARDWARE1             Serial1
#endif

#if !defined(SERIAL_PORT_HARDWARE2) && defined(configWIRING_USARTSERIAL2_ENABLE)
#define SERIAL_PORT_HARDWARE2             Serial2
#endif

#if !defined(SERIAL_PORT_HARDWARE3) && defined(configWIRING_USARTSERIAL3_ENABLE)
#define SERIAL_PORT_HARDWARE3             Serial3
#endif

#if !defined(SERIAL_PORT_HARDWARE4) && defined(configWIRING_USARTSERIAL4_ENABLE)
#define SERIAL_PORT_HARDWARE4             Serial4
#endif

#if !defined(SERIAL_PORT_HARDWARE5) && defined(configWIRING_USARTSERIAL5_ENABLE)
