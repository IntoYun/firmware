...
#if !defined(SERIAL_PORT_MONITOR) && defined(FIRMWARE_CONFIG_WIRING_USARTSERIAL_ENABLE)
#define SERIAL_PORT_MONITOR               Serial
#endif

#if !defined(SERIAL_PORT_USBVIRTUAL) && defined(FIRMWARE_CONFIG_WIRING_USBSERIAL_ENABLE)
#define SERIAL_PORT_USBVIRTUAL            SerialUSB
#endif

#if !defined(SERIAL_PORT_HARDWARE_OPEN) && defined(FIRMWARE_CONFIG_WIRING_USARTSERIAL_ENABLE)
#define SERIAL_PORT_HARDWARE_OPEN         Serial
#endif

#if !defined(SERIAL_PORT_HARDWARE_OPEN1) && defined(FIRMWARE_CONFIG_WIRING_USARTSERIAL1_ENABLE)
#define SERIAL_PORT_HARDWARE_OPEN1        Serial1
#endif

#if !defined(SERIAL_PORT_HARDWARE_OPEN2) && defined(FIRMWARE_CONFIG_WIRING_USARTSERIAL2_ENABLE)
#define SERIAL_PORT_HARDWARE_OPEN2        Serial2
#endif

#if !defined(SERIAL_PORT_HARDWARE_OPEN3) && defined(FIRMWARE_CONFIG_WIRING_USARTSERIAL3_ENABLE)
#define SERIAL_PORT_HARDWARE_OPEN3        Serial3
#endif

#if !defined(SERIAL_PORT_HARDWARE_OPEN4) && defined(FIRMWARE_CONFIG_WIRING_USARTSERIAL4_ENABLE)
#define SERIAL_PORT_HARDWARE_OPEN4        Serial4
#endif

#if !defined(SERIAL_PORT_HARDWARE_OPEN5) && defined(FIRMWARE_CONFIG_WIRING_USARTSERIAL5_ENABLE)
#define SERIAL_PORT_HARDWARE_OPEN5        Serial5
#endif

#if !defined(SERIAL_PORT_HARDWARE) && defined(FIRMWARE_CONFIG_WIRING_USARTSERIAL_ENABLE)
#define SERIAL_PORT_HARDWARE              Serial
#endif

#if !defined(SERIAL_PORT_HARDWARE1) && defined(FIRMWARE_CONFIG_WIRING_USARTSERIAL1_ENABLE)
#define SERIAL_PORT_HARDWARE1             Serial1
#endif

#if !defined(SERIAL_PORT_HARDWARE2) && defined(FIRMWARE_CONFIG_WIRING_USARTSERIAL2_ENABLE)
#define SERIAL_PORT_HARDWARE2             Serial2
#endif

#if !defined(SERIAL_PORT_HARDWARE3) && defined(FIRMWARE_CONFIG_WIRING_USARTSERIAL3_ENABLE)
#define SERIAL_PORT_HARDWARE3             Serial3
#endif

#if !defined(SERIAL_PORT_HARDWARE4) && defined(FIRMWARE_CONFIG_WIRING_USARTSERIAL4_ENABLE)
#define SERIAL_PORT_HARDWARE4             Serial4
#endif

#if !defined(SERIAL_PORT_HARDWARE5) && defined(FIRMWARE_CONFIG_WIRING_USARTSERIAL5_ENABLE)
