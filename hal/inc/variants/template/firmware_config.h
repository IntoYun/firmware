...
#define FIRMWARE_CONFIG_HAL_USB_HID 1

#define FIRMWARE_CONFIG_WIRING_WIFI 1
#define FIRMWARE_CONFIG_WIRING_CELLULAR 1
#define FIRMWARE_CONFIG_WIRING_LORA 1
#define FIRMWARE_CONFIG_WIRING_IPV6 1
#define FIRMWARE_CONFIG_WIRING_USB_USART 1
#define FIRMWARE_CONFIG_WIRING_USBMOUSE 1
#define FIRMWARE_CONFIG_WIRING_USBKEYBOARD 1
#define FIRMWARE_CONFIG_WIRING_USART_NUM 6
#define FIRMWARE_CONFIG_WIRING_USART 1
#define FIRMWARE_CONFIG_WIRING_USART1 1
#define FIRMWARE_CONFIG_WIRING_USART2 1
#define FIRMWARE_CONFIG_WIRING_USART3 1
#define FIRMWARE_CONFIG_WIRING_USART4 1
#define FIRMWARE_CONFIG_WIRING_USART5 1
#define FIRMWARE_CONFIG_WIRING_WIRE_NUM 3
#define FIRMWARE_CONFIG_WIRING_WIRE 1
#define FIRMWARE_CONFIG_WIRING_WIRE1 1
#define FIRMWARE_CONFIG_WIRING_WIRE2 1
#define FIRMWARE_CONFIG_WIRING_SPI_NUM 3
#define FIRMWARE_CONFIG_WIRING_SPI 1
#define FIRMWARE_CONFIG_WIRING_SPI1 1
#define FIRMWARE_CONFIG_WIRING_SPI2 1
#define FIRMWARE_CONFIG_WIRING_CAN_NUM 2
#define FIRMWARE_CONFIG_WIRING_CAN 1
#define FIRMWARE_CONFIG_WIRING_CAN1 1
