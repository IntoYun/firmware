...
#define FIRMWARE_CONFIG_WIRING_USART 6
#define FIRMWARE_CONFIG_WIRING_WIRE 3
#define FIRMWARE_CONFIG_WIRING_SPI 3
#define FIRMWARE_CONFIG_WIRING_I2S 3
#define FIRMWARE_CONFIG_WIRING_CAN 2
