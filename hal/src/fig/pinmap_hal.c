 ...
 * pwm_status
 */
/* D0               - 00 */ { GPIO_19, NONE, NONE, NONE, ESP32_TIMER_0, TIMER_PWM_CHANNEL_0, PIN_MODE_NONE, 0, 0 },
/* D1               - 01 */ { GPIO_23, NONE, NONE, NONE, ESP32_TIMER_0, TIMER_PWM_CHANNEL_1, PIN_MODE_NONE, 0, 0 },
/* D2               - 02 */ { GPIO_18, NONE, NONE, NONE, ESP32_TIMER_1, TIMER_PWM_CHANNEL_2, PIN_MODE_NONE, 0, 0 },
/* D3               - 03 */ { GPIO_17, NONE, NONE, NONE, ESP32_TIMER_1, TIMER_PWM_CHANNEL_3, PIN_MODE_NONE, 0, 0 },
/* D4               - 04 */ { GPIO_16, NONE, NONE, NONE, ESP32_TIMER_2, TIMER_PWM_CHANNEL_4, PIN_MODE_NONE, 0, 0 },
/* D5               - 05 */ { GPIO_5,  NONE, NONE, NONE, ESP32_TIMER_2, TIMER_PWM_CHANNEL_5, PIN_MODE_NONE, 0, 0 },
/* D6               - 06 */ { GPIO_4,  NONE, NONE, NONE, ESP32_TIMER_3, TIMER_PWM_CHANNEL_6, PIN_MODE_NONE, 0, 0 },
/* D7               - 07 */ { GPIO_4,  NONE, NONE, NONE, ESP32_TIMER_3, TIMER_PWM_CHANNEL_6, PIN_MODE_NONE, 0, 0 },
/* TXD              - 08 */ { GPIO_1,  NONE, NONE, NONE, NONE, NONE, PIN_MODE_NONE, 0, 0 },
/* RXD              - 09 */ { GPIO_3,  NONE, NONE, NONE, NONE, NONE, PIN_MODE_NONE, 0, 0 },
...
/* A0               - 30 */ { GPIO_36, NONE, ADC_CHANNEL, NONE, NONE, NONE, PIN_MODE_NONE, 0, 0 },
/* A1               - 31 */ { GPIO_39, NONE, ADC_CHANNEL, NONE, NONE, NONE, PIN_MODE_NONE, 0, 0 },
/* A2               - 32 */ { GPIO_35, NONE, ADC_CHANNEL, NONE, NONE, NONE, PIN_MODE_NONE, 0, 0 },
/* A3               - 33 */ { GPIO_25, NONE, ADC_CHANNEL, DAC_CHANNEL, ESP32_TIMER_3, TIMER_PWM_CHANNEL_7, PIN_MODE_NONE, 0, 0 },
/* A4               - 34 */ { GPIO_26, NONE, ADC_CHANNEL, DAC_CHANNEL, ESP32_TIMER_0, TIMER_PWM_CHANNEL_8, PIN_MODE_NONE, 0, 0 },
/* A5               - 35 */ { GPIO_14, NONE, ADC_CHANNEL, NONE, ESP32_TIMER_0, TIMER_PWM_CHANNEL_9, PIN_MODE_NONE, 0, 0 },
/* A6               - 36 */ { GPIO_12, NONE, ADC_CHANNEL, NONE, ESP32_TIMER_1, TIMER_PWM_CHANNEL_10, PIN_MODE_NONE, 0, 0 },
/* A7               - 37 */ { GPIO_15, NONE, ADC_CHANNEL, NONE, ESP32_TIMER_1, TIMER_PWM_CHANNEL_11, PIN_MODE_NONE, 0, 0 },
/* A8               - 38 */ { GPIO_13, NONE, ADC_CHANNEL, NONE, ESP32_TIMER_2, TIMER_PWM_CHANNEL_12, PIN_MODE_NONE, 0, 0 },
/* A9               - 39 */ { GPIO_2,  NONE, ADC_CHANNEL, NONE, ESP32_TIMER_2, TIMER_PWM_CHANNEL_13, PIN_MODE_NONE, 0, 0 },
/* LIGHT_SENSOR_UC  - 40 */ { GPIO_34, NONE, ADC_CHANNEL, NONE, NONE, NONE, PIN_MODE_NONE, 0, 0 },
};
