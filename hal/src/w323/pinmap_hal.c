...
/*             - 40 */ { GPIO34, NONE, ADC_CHANNEL, NONE, PIN_MODE_NONE },
/*             - 41 */ { GPIO35, NONE, ADC_CHANNEL, NONE, PIN_MODE_NONE },
/*             - 42 */ { GPIO36, NONE, ADC_CHANNEL, NONE, PIN_MODE_NONE },
/*             - 43 */ { GPIO39, NONE, ADC_CHANNEL, NONE, PIN_MODE_NONE },
};
