...
#define INTOROBOT_BOARD_NAME    "atom"
...
void read_boot_params(boot_params_t *pboot_params) {
    ...
    HAL_FLASH_Interminal_Read(BOOT_PARAMS_START_ADDR, (uint32_t *)pboot_params, len/4);
}
...
void save_boot_params(boot_params_t *pboot_params) {
    ...
    HAL_FLASH_Interminal_Write(BOOT_PARAMS_START_ADDR, (uint32_t *)pboot_params, len/4);
}
