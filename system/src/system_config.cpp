...
void DeviceConfig::dealCheckWifi(void)
{
    ...
    aJson.deleteItem(root);
#elif (defined FIRMWARE_CONFIG_WIRING_CELLULAR) || (defined FIRMWARE_CONFIG_WIRING_LORA)
    sendComfirm(200);
#endif
}
...
#ifdef FIRMWARE_CONFIG_WIRING_WIFI
    dealCheckWifi();
#elif defined FIRMWARE_CONFIG_WIRING_CELLULAR
    sendComfirm(200);
#elif defined FIRMWARE_CONFIG_WIRING_LORA
    sendComfirm(200);
#endif
}
...
#if (defined FIRMWARE_CONFIG_WIRING_WIFI) || (defined FIRMWARE_CONFIG_WIRING_CELLULAR)
    char domain[50] = {0};
