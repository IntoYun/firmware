...
void DeviceConfig::dealCheckWifi(void)
{
    ...
    aJson.deleteItem(root);
#elif FIRMWARE_CONFIG_WIRING_CELLULAR || FIRMWARE_CONFIG_WIRING_LORA
    sendComfirm(200);
#endif
}
...
#if FIRMWARE_CONFIG_WIRING_WIFI
    dealCheckWifi();
#elif FIRMWARE_CONFIG_WIRING_CELLULAR
    sendComfirm(200);
#elif FIRMWARE_CONFIG_WIRING_LORA
    sendComfirm(200);
#endif
}
...
#if FIRMWARE_CONFIG_WIRING_WIFI || FIRMWARE_CONFIG_WIRING_CELLULAR
    char domain[50] = {0};
