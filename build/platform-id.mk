...
ifeq ("$(PLATFORM)","gl2000-wifi")
PLATFORM_ID = 188002
endif

ifeq ("$(PLATFORM)","gl2000-gprs")
PLATFORM_ID = 178003
endif
...
ifeq ("$(PLATFORM_ID)","188002") #gl2000-wifi
PLATFORM=gl2000-wifi
PLATFORM_DEVICE=STM32F411xE
PLATFORM_NAME=gl2000-wifi
PLATFORM_MCU=STM32F4xx
MCU_CORE=cortex-m4
PRODUCT_DESC=IntoRobot gl2000 wifi, Internal flash 512k flash, 128k sram + SPI flash 4096K
PLATFORM_BOOT_ADDR=0x08000000
PLATFORM_APP_ADDR=0x08020000
PLATFORM_THREADING=1
SUBSYS_VERSION_STRING=$(SUBSYS_VERSION_STRING_GL2000_WIFI)
endif

ifeq ("$(PLATFORM_ID)","178003") #gl2000-gprs
PLATFORM=gl2000-gprs
PLATFORM_DEVICE=STM32F411xE
PLATFORM_NAME=gl2000-gprs
PLATFORM_MCU=STM32F4xx
MCU_CORE=cortex-m4
PRODUCT_DESC=IntoRobot gl2000 gprs, Internal flash 512k flash, 128k sram + SPI flash 4096K
PLATFORM_BOOT_ADDR=0x08000000
PLATFORM_APP_ADDR=0x08020000
PLATFORM_THREADING=1
SUBSYS_VERSION_STRING=$(SUBSYS_VERSION_STRING_GL2000_GPRS)
endif
