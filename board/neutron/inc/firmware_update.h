...
class FirmwareUpdateClass
{
    public:
        ...
        bool st_firmware_down(const char *domain, const char *param, const char * md5);
        bool st_firmware_update(void);
        bool st_firmware_isupdate(void);
        bool st_firmware_clearupdate(void);
        bool net_firmware_version(char *p_version);
        bool net_firmware_down(const char *domain, const char *param);
        bool net_firmware_update(void);
        bool net_firmware_isupdate(void);
        bool net_firmware_clearupdate(void);
