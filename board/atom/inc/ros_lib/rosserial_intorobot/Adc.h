#ifndef _ROS_rosserial_intorobot_Adc_h
#define _ROS_rosserial_intorobot_Adc_h
...
namespace rosserial_intorobot
{
  ...
  class Adc : public ros::Msg
  {
    ...
    const char * getType(){ return "rosserial_intorobot/Adc"; };
