 ...
 * @brief     : Main Interrupt Service Routines.This file provides template for all exceptions handler 
 and peripheralsinterrupt service routine.
 ******************************************************************************
...
void Wiring_USART3_Interrupt_Handler(void) __attribute__ ((weak));
...
void Wiring_I2C2_EV_Interrupt_Handler(void) __attribute__ ((weak));
void Wiring_I2C2_ER_Interrupt_Handler(void) __attribute__ ((weak));
void Wiring_SPI1_Interrupt_Handler(void) __attribute__ ((weak));
void Wiring_SPI2_Interrupt_Handler(void) __attribute__ ((weak));
...
void (*Wiring_TIM1_Interrupt_Handler)(void);
...
{
	if(NULL != Wiring_USART3_Interrupt_Handler)
	{
		Wiring_USART3_Interrupt_Handler();
	}
}
...
{
	if(NULL != Wiring_I2C2_EV_Interrupt_Handler)
	{
		Wiring_I2C2_EV_Interrupt_Handler();
	}
}
...
{
	if(NULL != Wiring_I2C2_ER_Interrupt_Handler)
	{
		Wiring_I2C2_ER_Interrupt_Handler();
	}
}
...
{
	if(NULL != Wiring_SPI2_Interrupt_Handler)
	{
		Wiring_SPI2_Interrupt_Handler();
	}
}
...
void TIM1_UP_IRQHandler(void)
{
	...
	{	
	        ...
	        if(NULL != Wiring_TIM1_Interrupt_Handler)
		{
		         Wiring_TIM1_Interrupt_Handler();
		}
