...
void attachInterrupt(uint16_t pin, voidFuncPtr handler, InterruptMode mode)
{
    ...
    /* 在stm32f10x_gpio.h中有定义 #define GPIO_PortSourceGPIOA       ((uint8_t)0x00)
    端口源					   #define GPIO_PortSourceGPIOB       ((uint8_t)0x01)
    LZ 修改					   #define GPIO_PortSourceGPIOC       ((uint8_t)0x02)
...
/*********************************************************************************
  *Function     : void detachInterrupt(uint16_t pin)
  *Description  : IntoRobot compatible function to detach hardware interrupts that
				  were asssigned previously using attachInterrupt
  *Input        : pin:pin number to which the interrupt was attached
  *Output       : none
  *Return       : none
  *author       : lz
  *date         : 6-December-2014
...
void detachInterrupt(uint16_t pin)
{
    ...
    //Map the IntoRobot pin to the appropriate pin on the STM32
    uint16_t gpio_pin = PIN_MAP[pin].gpio_pin;
...
/*********************************************************************************
  ...
  *author       : lz
  *date         : 6-December-2014
  *Others       : EXTI_Line_Number (Supported: 0, 1, 3, 4, 5, 6, 7, 13, 14 and 15)
**********************************************************************************/
