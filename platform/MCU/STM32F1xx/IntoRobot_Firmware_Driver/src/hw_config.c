...
void USB_Cable_Initial(void)
{
    ...
    GPIO_InitStruct.Pin = USB_DISCONNECT_GPIO_PIN;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_HIGH;
    HAL_GPIO_Init(USB_DISCONNECT_GPIO_PORT, &GPIO_InitStruct);

    HAL_GPIO_WritePin(USB_DISCONNECT_GPIO_PORT, USB_DISCONNECT_GPIO_PIN, GPIO_PIN_SET);
}
...
void USB_Cable_Config(FunctionalState NewState)
{
    if (NewState == DISABLE)
    {
        HAL_GPIO_WritePin(USB_DISCONNECT_GPIO_PORT, USB_DISCONNECT_GPIO_PIN, GPIO_PIN_RESET);
    }
    else
    {
        HAL_GPIO_WritePin(USB_DISCONNECT_GPIO_PORT, USB_DISCONNECT_GPIO_PIN, GPIO_PIN_SET);
