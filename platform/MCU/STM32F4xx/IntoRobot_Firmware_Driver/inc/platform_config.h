...
#if PLATFORM_FOX == PLATFORM_ID || PLATFORM_GL2000_WIFI == PLATFORM_ID || PLATFORM_GL2000_GPRS == PLATFORM_ID
...
#if PLATFORM_ID == PLATFORM_NEUTRON || PLATFORM_ID == PLATFORM_FOX || PLATFORM_ID == PLATFORM_GL2000_WIFI || PLATFORM_ID == PLATFORM_GL2000_GPRS
