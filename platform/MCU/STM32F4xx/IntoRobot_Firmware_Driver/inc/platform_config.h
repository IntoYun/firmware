...
#if PLATFORM_LITTLEBEE == PLATFORM_ID || PLATFORM_LORAGATEWAY == PLATFORM_ID
...
#if PLATFORM_ID == PLATFORM_NEUTRON || PLATFORM_ID == PLATFORM_LITTLEBEE || PLATFORM_ID == PLATFORM_LORAGATEWAY
